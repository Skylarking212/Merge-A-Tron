...
const NavTab = memo(({ label, onClick, isActive }) => (
  <button
    onClick={onClick}
    className={`
      ${isActive ? 'bg-gradient-to-r from-blue-600 to-indigo-700 text-white shadow-lg' : 'bg-slate-800/60 text-slate-300 hover:bg-slate-700/60'}
      px-6 py-3 text-center font-bold rounded-full transition-all focus:outline-none transform hover:scale-105 active:scale-95
    `}
  >
    {label}
  </button>
...
const CountdownUnit = memo(({ value, label, icon }) => (
  <div className="flex flex-col items-center">
    <div className="relative">
      <div className="bg-gradient-to-br from-white-100 to-orange-200 text-6xl font-bold text-white rounded-2xl p-6 min-w-20 shadow-lg flex items-center justify-center">
      ...
      {isOpen && (
        <div className="mt-3">
          {answer ? (
            ...
            <p className="text-blue-300 italic">Answer coming soon...</p>
          )}
        </div>
      )}
    </div>
...
const PrizeItem = memo(({ title, description, prize, color = "from-indigo-500 to-blue-600" }) => (
  <div className={`bg-gradient-to-r ${color} p-[3px] rounded-2xl shadow-lg mb-6 backdrop-blur-sm`}>
    <div className="bg-slate-900/80 p-6 rounded-2xl h-full">
      ...
      <div className="font-bold text-white p-3 bg-slate-800/70 rounded-xl mt-4">{prize}</div>
    </div>
  </div>
));

const GlowingBadge = memo(({ children, color = "glowy from-blue-500 to-purple-600" }) => (
  <span className={`relative inline-block bg-gradient-to-r ${color} px-4 py-2 rounded-lg text-white font-semibold text-sm`}>
    {children}
  </span>
));
...
const CountdownTimer = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-slate-800/90 to-slate-900/90 p-8 rounded-3xl shadow-xl mt-6 backdrop-blur-md border border-slate-700/50">
      ...
      <h3 className="text-center text-3xl font-bold text-transparent bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text mt-10">
...
export default function Home() {
  ...
  // Replace your current handleAuth function with this one:
  const handleAuth = useCallback(async (e) => {
    ...
    try {
      if (authMode === 'signup') {
        ...
        // Also create user in custom User table
        try {
  ...
  }, [authMode, email, password, firstName, lastName]);
        ...
        return (
          <div className="bg-gradient-to-b from-slate-800/90 to-slate-900/90 p-8 rounded-2xl shadow-lg border border-slate-700/50 backdrop-blur-sm">
            ...
            <p className="text-lg text-blue-100 mb-8">
              Welcome to HackPSU, Penn State's largest hackathon! Get ready for 24 hours of coding, creativity, and collaboration.
            </p>
            <div className="bg-slate-800/50 p-6 rounded-xl mb-8 border border-slate-700/50">
              ...
              <ul className="space-y-4 text-blue-100 list-inside list-disc">
                <li>All participants must be at least 18 years old and a student of some university (or a recent PSU graduate within less than one year).</li>
                <li>Teams may be comprised of up to five members. A team may only submit one project.</li>
                <li>Projects should be original works created on site. Coming with an idea in mind is perfectly fine, working on an existing project is not.</li>
                <li>All projects must be submitted through Devpost by 12PM on Sunday (even if not completed!) and can be edited until 1:45PM Sunday.</li>
                <li>All project code must be attached to the project's Devpost submission.</li>
                <li>Students are permitted to come and go from the venue as they please.</li>
                <li>Anything you create is your work, HackPSU and its partners have no claim over intellectual property produced at the event.</li>
                <li>All participants must agree to the MLH Code of Conduct.</li>
              </ul>
            </div>
            <h3 className="text-2xl font-bold bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent mb-4">
              FAQ
          ...
          <div className="bg-gradient-to-b from-slate-800/90 to-slate-900/90 p-8 rounded-2xl shadow-lg border border-slate-700/50 backdrop-blur-sm">
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-800/40 rounded-b-xl divide-y divide-slate-700/50">
                <ScheduleItem location="Atrium" activity="Merch Handout" time="10:00 AM" />
                <ScheduleItem location="Auditorium" activity="Opening Ceremonies" time="12:00 PM" />
                <ScheduleItem location="Atrium" activity="Lunch" time="1:00 PM" />
                <ScheduleItem location="Atrium" activity="Hacking Begins" time="2:00 PM" />
                <ScheduleItem location="Atrium" activity="Dinner" time="7:00 PM" />
                <ScheduleItem location="Atrium" activity="Air Mattress Handout" time="10:00 PM" />
              </div>
            </div>
            <div className="mb-8">
              ...
              <div className="bg-slate-800/40 rounded-b-xl divide-y divide-slate-700/50">
                <ScheduleItem location="Atrium" activity="Midnight Snack" time="12:00 AM" />
                <ScheduleItem location="Atrium" activity="Brunch" time="10:00 AM" />
                <ScheduleItem location="Atrium" activity="Air Mattress Return" time="10:00 AM" />
                <ScheduleItem location="Atrium" activity="Hacking Ends" time="1:45 PM" />
                <ScheduleItem location="Atrium" activity="Judging Expo" time="2:00 PM" />
                <ScheduleItem location="Atrium" activity="Closing Ceremonies" time="4:30 PM" />
              </div>
            </div>
            <div className="bg-gradient-to-r from-red-600 to-red-500 p-5 rounded-xl text-white mt-8 shadow-lg flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-bold text-xl mb-2">IMPORTANT SUBMISSION DEADLINE</h3>
                <p>
                  All projects must be submitted through Devpost by <span className="font-bold text-yellow-200">12PM on Sunday</span>.
                  You can edit your submission until <span className="font-bold text-yellow-200">1:45PM Sunday</span>. This is a hard deadline!
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-b from-slate-800/90 to-slate-900/90 p-8 rounded-2xl shadow-lg border border-slate-700/50 backdrop-blur-sm">
              ...
              <PrizeItem
                ...
                prize={
                  <div className="space-y-2">
                    <p>• ICDS developed press release on winning team's submission</p>
                    <p>• Social media promotion on ICDS branded channels</p>
                    <p>• LinkedIn endorsement referencing winning team's submission</p>
                    <p>• Presentation invite to a future ICDS Lunch and Learn</p>
                  </div>
                }
            ...
            <div className="mt-10 p-6 bg-gradient-to-r from-blue-900/60 to-indigo-900/60 rounded-xl border border-blue-500/30 backdrop-blur-sm">
              ...
              <p className="mb-3 text-blue-100">
                ...
                <a href="http://devpost.hackpsu.org" className="text-blue-300 underline font-bold hover:text-blue-200 transition-colors">
                  devpost.hackpsu.org
                </a>
              </p>
              <ul className="list-disc pl-6 space-y-2 text-blue-100">
                <li>
                  Submit your project (even if not completed) by <GlowingBadge>12 PM Sunday</GlowingBadge>
                </li>
                <li>
                  You can edit until <GlowingBadge color="from-purple-500 to-pink-600">1:45 PM Sunday</GlowingBadge>
                </li>
                <li>This is a hard deadline - the submission portal closes at 12 PM</li>
                <li>Projects not submitted will not be considered for prizes</li>
              </ul>
            </div>
          </div>
        );
      case 'teams':
      // In the renderContent function, replace the teams case with:
      case 'teams':
        return (
          <div className="bg-gradient-to-b from-slate-800/90 to-slate-900/90 p-8 rounded-2xl shadow-lg border border-slate-700/50 backdrop-blur-sm">
            <div className="py-10">
              <div className="flex flex-col items-center">
                ...
                <p className="text-xl text-blue-100 text-center max-w-2xl mb-8">
                  Form your team of up to 5 members and get ready to build something amazing!
                </p>
                <div className="flex space-x-4">
                  <button
                    onClick={() => router.push('/teams')}
                    className="bg-gradient-to-r from-indigo-600 to-blue-700 text-white font-bold py-3 px-6 rounded-full shadow-lg hover:shadow-xl transition-all transform hover:scale-105 active:scale-95"
                  >
                    Browse Teams
                  </button>
                  <button
                    onClick={() => router.push('/create-team')}
                    className="bg-gradient-to-r from-purple-600 to-pink-700 text-white font-bold py-3 px-6 rounded-full shadow-lg hover:shadow-xl transition-all transform hover:scale-105 active:scale-95"
                  >
                    Create Team
                  </button>
                </div>
          ...
          <div className="bg-gradient-to-b from-slate-800/90 to-slate-900/90 p-8 rounded-2xl shadow-lg border border-slate-700/50 backdrop-blur-sm">
            <div className="py-10">
              <div className="flex flex-col items-center">
                ...
                <p className="text-xl text-blue-100 text-center max-w-2xl mb-8">
                  {activeTab === 'teams' && 'Team registration will open soon. Form your team of up to 5 members and get ready to build something amazing!'}
                  {activeTab === 'sponsors' && 'Our sponsors make HackPSU possible. Check back soon to see which companies are supporting innovation at Penn State!'}
                  {activeTab === 'workshops' && 'Learn new skills with our interactive workshops. Schedule and topics coming soon!'}
                </p>
                <button
                  onClick={() => { }}
                  className={`
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 min-h-screen">
        {/* Header */}
        <header className="glowy backdrop-blur-md bg-slate-900/50 border-b border-slate-700/50 sticky top-0 z-20">
          <nav className="container glowy mx-auto flex flex-wrap justify-center gap-3 px-4 py-5">
            <NavTab label="INFO" onClick={() => setActiveTab('info')} isActive={activeTab === 'info'} />
            <NavTab label="SCHEDULE" onClick={() => setActiveTab('schedule')} isActive={activeTab === 'schedule'} />
            <NavTab label="PRIZES" onClick={() => setActiveTab('prizes')} isActive={activeTab === 'prizes'} />
            <NavTab label="TEAMS" onClick={() => router.push('/teams')} isActive={activeTab === 'teams'} />
            <NavTab label="SPONSORS" onClick={() => setActiveTab('sponsors')} isActive={activeTab === 'sponsors'} />
            <NavTab label="WORKSHOPS" onClick={() => setActiveTab('workshops')} isActive={activeTab === 'workshops'} />
            <NavTab
            ...
            {isLoggedIn && (
              <button
                ...
                className="bg-slate-800/60 text-slate-300 hover:bg-slate-700/60 px-6 py-3 text-center font-bold rounded-full transition-all focus:outline-none transform hover:scale-105 active:scale-95"
              >
                SIGN OUT
              </button>
            )}
        ...
        <main className="container mx-auto px-4 py-10">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-indigo-600 via-blue-600 to-purple-700 rounded-3xl p-8 shadow-2xl border border-indigo-500/50 overflow-hidden relative">
              ...
              <h1 className="text-center text-7xl font-extrabold font-sans drop-shadow-md" style={{ color: '#911b0b' }}>
          ...
          <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-gradient-to-b from-slate-800 to-slate-900 rounded-2xl max-w-md w-full p-6 relative shadow-xl border border-slate-700">
              ...
              <h2 className="text-2xl font-bold mb-6 text-center text-white bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">
                {authMode === 'signin' ? 'Get Your Ticket!' : 'Register for HackPSU'}
              </h2>
              <form onSubmit={handleAuth} className="space-y-5">
                <div className="space-y-2">
                  ...
                  />
                  // Add this code in your form, between the email input and password input:
                  {authMode === 'signup' && (
                    <>
                      <div className="space-y-2">
        ...
        <footer className="mt-20 bg-gradient-to-t from-slate-900 to-transparent py-8 text-center">
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center">
              <h2 className="text-2xl font-bold text-white mb-4">HackPSU Spring 2025</h2>
              <p className="text-blue-200 mb-6">Learn. Build. Share.</p>
              <div className="flex space-x-6">
                <a href="https://twitter.com/hackpsu" className="text-blue-400 hover:text-blue-300 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path>
                  </svg>
                </a>
                <a href="https://www.instagram.com/hackpsu/" className="text-pink-400 hover:text-pink-300 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <a href="https://github.com/hackpsu" className="text-slate-400 hover:text-slate-300 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
